...
namespace Continental.API.Infrastructure.Migrations
{
    ...
    [Migration("20220301194555_FixCasesEntity")]
    partial class FixCasesEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaseResolutionArea", b =>
                {
                    b.Property<int>("CasesId")
                        .HasColumnType("integer");

                    b.Property<int>("ResolutionAreasId")
                        .HasColumnType("integer");

                    b.HasKey("CasesId", "ResolutionAreasId");

                    b.HasIndex("ResolutionAreasId");
            ...
            modelBuilder.Entity("CaseResolutionArea", b =>
                {
                    ...
                    b.HasOne("Continental.API.Core.Entities.Common.ResolutionArea", null)
                        .WithMany()
                        .HasForeignKey("ResolutionAreasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Continental.API.Core.Entities.Cases.Case", b =>
                {
                    ...
                    b.HasOne("Continental.API.Core.Entities.User.User", null)
                        .WithMany("Cases")
