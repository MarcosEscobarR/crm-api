...
namespace Continental.API.Infrastructure.Migrations
{
    ...
    [Migration("20220301190344_FixCasesAndUserEntity")]
    partial class FixCasesAndUserEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Continental.API.Core.Entities.Cases.Case", b =>
                {
                    ...
                    b.Property<int?>("UserWhoCreatedId1")
                        .HasColumnType("integer");

                    b.Property<int?>("UserWhoModifiedId")
                        .HasColumnType("integer");

                    b.Property<int?>("UserWhoModifiedId1")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserWhoCreatedId1");

                    b.HasIndex("UserWhoModifiedId1");
            ...
            modelBuilder.Entity("Continental.API.Core.Entities.Contact.Contact", b =>
                {
                    ...
                    b.Property<int?>("BranchManagerUserId1")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("SupervisorUserId1")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("TeamLeaderUserId1")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BranchManagerUserId1");
                    ...
                    b.HasIndex("SupervisorUserId1");

                    b.HasIndex("TeamLeaderClerkId");

                    b.HasIndex("TeamLeaderUserId1");
            ...
            modelBuilder.Entity("Continental.API.Core.Entities.Common.ResolutionArea", b =>
                {
                    b.HasOne("Continental.API.Core.Entities.Cases.Case", null)
                        .WithMany("ResolutionAreas")
            ...
            modelBuilder.Entity("Continental.API.Core.Entities.Company.Company", b =>
                {
                    ...
                    b.HasOne("Continental.API.Core.Entities.Lead.Lead", "Lead")
                        .WithMany()
                    ...
                    b.HasOne("Continental.API.Core.Entities.Company.Company", "ParentCompany")
                        .WithMany()
            ...
            modelBuilder.Entity("Continental.API.Core.Entities.Contact.Contact", b =>
                {
                    ...
                    b.HasOne("Continental.API.Core.Entities.User.User", "BranchManagerUser")
                        .WithMany()
                        .HasForeignKey("BranchManagerUserId1");
                    ...
                    b.HasOne("Continental.API.Core.Entities.User.User", "SupervisorUser")
                        .WithMany()
                        .HasForeignKey("SupervisorUserId1");
                    ...
                    b.HasOne("Continental.API.Core.Entities.User.User", "TeamLeaderUser")
                        .WithMany()
                        .HasForeignKey("TeamLeaderUserId1");
